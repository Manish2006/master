# The name of this view in Looker is "Baseball"
view: baseball {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `applied-dialect-337706.covid_insights.baseball`
    ;;
  ...
  # This dimension will be called "At Bat Event Sequence Number" in Explore.
  ...
  measure: total_at_bat_event_sequence_number {
    type: sum
    sql: ${at_bat_event_sequence_number} ;;
  }

  measure: average_at_bat_event_sequence_number {
    type: average
    sql: ${at_bat_event_sequence_number} ;;
  }
